          ...
          <div className="flex flex-col justify-center">
            <div className="space-y-8">
              ...
              <div>
                ...
                <p className="font-heading text-lg text-black">Salon Sara</p>
              ...
              <div>
                ...
                <div className="space-y-3 text-[0.9375rem]">
                  <div className="flex justify-between rounded-xl bg-gray-lighter p-4">
                    ...
                    <span className="font-medium text-black">07:00 – 21:00 Uhr</span>
                  </div>
                  <div className="flex justify-between rounded-xl bg-gray-lighter p-4">
              ...
              <div>
                ...
                <div className="space-y-3">
                  <a href="tel:+4921224926647" className="flex items-center gap-3 text-[0.9375rem] text-black transition-colors hover:text-gold">
                    <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-lighter">
                  ...
                  <a href="https://wa.me/4921224926647" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-[0.9375rem] text-black transition-colors hover:text-gold">
                    <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-lighter">
              ...
              <div className="flex flex-col gap-3 pt-2 sm:flex-row">
                <a href="tel:+4921224926647" className="btn-primary">
                  <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/>
                  </svg>
                  Jetzt Anrufen
                </a>
                <a href="https://wa.me/4921224926647" target="_blank" rel="noopener noreferrer" className="btn-secondary">
