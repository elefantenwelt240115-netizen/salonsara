    ...
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden bg-dark">
      ...
      {showCallPopup && (
        ...
        >
          ...
          {/* Modal */}
          <div
            className="relative w-full max-w-sm rounded-2xl border border-white/10 bg-dark p-8 shadow-2xl"
          ...
          >
            ...
            <h3 className="mb-2 text-center text-lg font-bold text-white">Jetzt Anrufen</h3>
            <p className="mb-6 text-center text-sm text-white/40">Welche Filiale möchten Sie erreichen?</p>

            <div className="space-y-3">
              <a
                href="tel:+4921224926647"
                className="flex items-center gap-4 rounded-xl border border-white/10 bg-white/5 p-4 transition-all hover:border-gold/40 hover:bg-gold/10"
              >
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-gold/15">
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#B8956A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/>
                  </svg>
                </div>
                <div>
                  <span className="text-sm font-semibold text-white">Filiale 1</span>
                  <br />
                  <span className="text-sm text-white/50">0212 – 249 266 47</span>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  <span className="text-sm font-semibold text-white">Filiale 2</span>
                  <br />
                  <span className="text-sm text-white/50">0212 – 128 582 00</span>
                </div>
              </a>
            </div>
          </div>
